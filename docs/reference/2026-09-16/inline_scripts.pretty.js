...
document.addEventListener("DOMContentLoaded", function () {
  var t = new Lenis({ lerp: 0.1, wheelMultiplier: 1 });
  function e(n) {
    (t.raf(n), requestAnimationFrame(e));
  }
  ((window.lenis = t),
    requestAnimationFrame(e),
    document.querySelectorAll("[data-lenis-start]").forEach(function (e) {
      e.addEventListener("click", function () {
        t.start();
      });
    }),
    document.querySelectorAll("[data-lenis-stop]").forEach(function (e) {
      e.addEventListener("click", function () {
        t.stop();
      });
    }),
    document.querySelectorAll("[data-lenis-toggle]").forEach(function (e) {
      e.addEventListener("click", function () {
        (this.classList.toggle("stop-scroll"),
          this.classList.contains("stop-scroll") ? t.stop() : t.start());
      });
    }));
});
...
!(function () {
  let e = "cookie-banner-closed";
  function t() {
    let t = document.querySelector('[data-cookie="trigger"]');
    if (t) {
      ...
      (setTimeout(function e() {
        ...
        document.addEventListener("click", function (i) {
          let n = i.target.closest('[data-cookie="close"]');
          n && (localStorage.setItem(e, "1"), t.classList.remove("active"));
        }));
    }
  }
...
!(function () {
  "use strict";
  try {
    if (null === localStorage.getItem("1")) return;
  } catch (t) {
    return;
  }
  (document.documentElement.classList.add("preloader-skip"),
    (window.__PRELOADER_SKIP__ = !0));
})();
...
!(function () {
  ...
  var e = [
      {
        id: "w-node-f451bb51-2dd3-54c9-fb38-8c90f8187841-f818781b",
        x: "30.8svw",
        opacity: 0,
      },
      {
        id: "w-node-f451bb51-2dd3-54c9-fb38-8c90f818785d-f818781b",
        x: "-30.8svw",
        opacity: 0,
      },
      {
        id: "w-node-f451bb51-2dd3-54c9-fb38-8c90f8187843-f818781b",
        x: "26.4svw",
        opacity: 0,
      },
      {
        id: "w-node-f451bb51-2dd3-54c9-fb38-8c90f818785b-f818781b",
        x: "-26.4svw",
        opacity: 0,
      },
      {
        id: "w-node-f451bb51-2dd3-54c9-fb38-8c90f8187845-f818781b",
        x: "22svw",
      },
      {
        id: "w-node-f451bb51-2dd3-54c9-fb38-8c90f8187859-f818781b",
        x: "-22svw",
      },
      {
        id: "w-node-f451bb51-2dd3-54c9-fb38-8c90f8187847-f818781b",
        x: "17.6svw",
      },
      {
        id: "w-node-f451bb51-2dd3-54c9-fb38-8c90f8187857-f818781b",
        x: "-17.6svw",
      },
      {
        id: "w-node-f451bb51-2dd3-54c9-fb38-8c90f8187849-f818781b",
        x: "13.2svw",
      },
      {
        id: "w-node-f451bb51-2dd3-54c9-fb38-8c90f8187855-f818781b",
        x: "-13.2svw",
      },
      {
        id: "w-node-f451bb51-2dd3-54c9-fb38-8c90f818784b-f818781b",
        x: "8.8svw",
      },
      {
        id: "w-node-f451bb51-2dd3-54c9-fb38-8c90f8187853-f818781b",
        x: "-8.8svw",
      },
      {
        id: "w-node-f451bb51-2dd3-54c9-fb38-8c90f818784d-f818781b",
        x: "4.4svw",
      },
      {
        id: "w-node-f451bb51-2dd3-54c9-fb38-8c90f8187851-f818781b",
        x: "-4.4svw",
      },
    ],
    o = [
  ...
  function t(e) {
    (e && gsap.set(e, { display: "none" }),
      window.lenis &&
        "function" == typeof window.lenis.start &&
        window.lenis.start());
  }
  function a(e, o, r, t, a, d) {
    o.forEach(function (o, i) {
      var n = document.getElementById(o.id);
      if (n) {
        var s = { x: o.x, duration: a, ease: d };
        (0 === o.opacity && (s.opacity = 0), e.to(n, s, r + i * t));
      }
    });
  }
  function d(e, o) {
  ...
  function i(i, n) {
    if (
      (r(),
      i.header && i.header.classList.add("is-hide"),
      (s = n).headChars.length &&
        gsap.to(s.headChars, {
          duration: 1.5,
          opacity: 1,
          yPercent: 0,
      ...
      (c.to(
        i.firstItems,
        { y: "-6.25svw", duration: 0.65, ease: "power2.inOut" },
        0,
      ),
        c.to(
          i.secondItems,
        ...
        a(c, o, 0.9, 0.02, 0.55, "power2.inOut"),
        c.call(
          function () {
            d(n, i.wf5);
          },
        ...
        c.to(
          i.preloaderImageAbs,
          { opacity: 0, duration: 0.35, ease: i.wf4 },
          1.9,
        ),
        c.to(
          i.imageHero,
        ...
        c.to(i.preloader, { backgroundColor: "transparent", ease: i.wf5 }, 2.1),
        c.to(i.preloaderBack, { opacity: 0, ease: i.wf5 }, 2.1),
        c.to(
          i.imageHero,
          {
            width: "100svw",
        ...
        c.call(
          function () {
            i.header && i.header.classList.remove("is-hide");
          },
          null,
          3.9,
        ),
        c.to(
          i.preloaderContent,
          { opacity: 0, duration: 0.35, ease: i.wf6 },
          2.45,
        ),
        c.to(
          i.heroContent,
          { opacity: 1, y: "0%", duration: 0.55, ease: i.wf5 },
          2.75,
        ));
      var u = document.querySelectorAll('[data-preload="main-head"]');
      (u.length &&
        "undefined" != typeof SplitText &&
        u.forEach(function (e) {
          var o = new SplitText(e, {
            type: "words,chars",
        ...
        c.to(i.heroContent, { y: "0%", duration: 0.55, ease: i.wf5 }, 2.75));
      return;
    }
    var f = gsap.timeline({
      delay: 1,
    ...
    (f.to(
      i.firstItems,
      { y: "-2.2svw", duration: 0.608, ease: "power2.out" },
      0,
    ),
      f.to(
        i.secondItems,
      ...
      a(f, e, 1.05, 0.02, 0.52, "power2.out"),
      f.call(
        function () {
          d(n, i.wf5);
        },
      ...
      f.to(i.preloader, { backgroundColor: "transparent", ease: i.wf5 }, 1.9),
      f.to(i.preloaderBack, { opacity: 0, ease: i.wf5 }, 1.9),
      f.to(
        i.preloaderImageAbs,
        { opacity: 0, duration: 0.25, ease: i.wf4 },
        1.9,
      ),
      f.to(
        i.imageHero,
        { width: "42svw", height: "28svw", duration: 0.77, ease: i.wf4 },
        1.9,
      ),
      f.to(i.heroImg, { scale: 1.25, duration: 1.55, ease: i.wf6 }, 1.99),
      f.to(
        i.imageHero,
        { width: "100svw", height: "100svh", duration: 0.76, ease: i.wf5 },
        2.68,
      ),
      f.to(
        i.heroContent,
        { opacity: 1, y: "0%", duration: 0.45, ease: i.wf5 },
        2.76,
      ));
    var l = document.querySelectorAll('[data-preload="main-head"]');
    (l.length &&
      "undefined" != typeof SplitText &&
      l.forEach(function (e) {
        ...
        (gsap.set(e, { visibility: "visible" }),
          gsap.set(o.words, { display: "inline-block", whiteSpace: "nowrap" }),
          gsap.set(o.chars, {
            opacity: 0,
            yPercent: 20,
            willChange: "transform,opacity",
      ...
      f.to(
        i.preloaderContent,
        { opacity: 0, duration: 0.25, ease: i.wf6 },
        2.78,
      ));
  }
  function n() {
    if ("undefined" != typeof gsap) {
      ...
      if (e.preloader) {
        (r(),
          (o = e).preloader &&
            (o.preloaderText &&
              gsap.set(o.preloaderText, { visibility: "hidden" }),
            o.imageHero &&
            ...
            o.heroImg &&
              (o.heroImg.classList.remove("is-blur"),
              gsap.set(o.heroImg, {
                opacity: 1,
                filter: "none",
                scale: 1,
            ...
            gsap.set(o.heroContent, { opacity: 0, y: "3%" }),
            o.header && o.header.classList.add("is-hide")));
        var o,
          t,
          a = { headChars: [], bodyWords: [] };
        ((t = function () {
          ((a = (function e(o) {
            if (!o || "undefined" == typeof SplitText)
              return { headChars: [], bodyWords: [] };
            if ("function" == typeof gsap.registerPlugin)
              try {
                gsap.registerPlugin(SplitText);
              } catch (r) {}
            gsap.set(o, { visibility: "hidden" });
            var t = o.querySelector(".u-head_one"),
              a = o.querySelector(".u-body_body"),
              d = [],
              i = [];
            if (t) {
              var n = new SplitText(t, {
                type: "words,chars",
                charsClass: "char-wrap",
                wordsClass: "word-wrap",
              });
            ...
            return (
              o.classList.add("is-text-ready"),
              gsap.set(o, { visibility: "visible" }),
              { headChars: d, bodyWords: i }
            );
          })(e.preloaderText)),
          ...
          document.fonts && document.fonts.ready
            ? document.fonts.ready.then(t).catch(t)
            : t());
      }
    }
  }
...
document.addEventListener("DOMContentLoaded", () => {
  let e = document.querySelector('[data-button-swap="swap-trigger"]');
  if (!e) return;
  let t = e.querySelector('[data-text="show-swap"]');
  if (!t) return;
  let r = !1;
  e.addEventListener("click", () => {
    ((r = !r), (t.innerText = r ? "show less" : "show more"));
  });
});
...
document.addEventListener("DOMContentLoaded", function () {
  let e = "modal_state-open";
  (document.querySelectorAll("[data-trigger]").forEach((t) => {
    let a = t.getAttribute("data-trigger");
    t.addEventListener("click", () => {
      let t = document.querySelector(`[data-modal="${a}"]`);
      t && t.classList.add(e);
    });
  }),
    document.querySelectorAll("[data-close-modal]").forEach((t) => {
      let a = t.getAttribute("data-close-modal");
      t.addEventListener("click", () => {
        let t = document.querySelector(`[data-modal="${a}"]`);
...
document.addEventListener("DOMContentLoaded", () => {
  let e = document.querySelectorAll('[data-copy="link"]');
  if (0 === e.length) {
    console.warn('Элементы с data-copy="link" не найдены');
    return;
  }
  e.forEach((e) => {
    let t = e.querySelector('[data-copy="clicked"]');
    if (!t) {
      console.warn(
        'Внутри элемента с data-copy="link" не найден data-copy="clicked"',
      );
      return;
    }
    e.addEventListener("click", async () => {
      ...
      try {
        ...
        console.error("Не удалось скопировать ссылку:", a);
      }
    });
  });
});
...
document.addEventListener("DOMContentLoaded", () => {
  let t = document.querySelectorAll(".u-image"),
    e = document.querySelectorAll('[data-animation="false"]');
  e.forEach((t) => {
    t.classList.contains("is-blur") && t.classList.remove("is-blur");
  });
  let i = Array.from(t).filter(
    (t) =>
      !t.hasAttribute("data-animation") ||
      "false" !== t.getAttribute("data-animation"),
  );
  function a(t) {
  ...
  function s() {
    i.forEach((t) => {
      t.classList.contains("is-blur") && a(t) && t.classList.remove("is-blur");
    });
  }
  s();
  let r = new IntersectionObserver(
    (t) => {
      t.forEach((t) => {
        t.isIntersecting &&
          t.target.classList.contains("is-blur") &&
          t.target.classList.remove("is-blur");
      });
    },
    { threshold: 0.01 },
  );
  (i.forEach((t) => r.observe(t)),
    (window.observeNewImages = function (t) {
      let e = t.querySelectorAll ? t.querySelectorAll(".u-image") : e;
      Array.from(e).forEach((t) => {
        (!t.hasAttribute("data-animation") ||
          "false" !== t.getAttribute("data-animation")) &&
          t.classList.contains("is-blur") &&
          (a(t) ? t.classList.remove("is-blur") : r.observe(t));
      });
    }));
});
...
!(function () {
  ...
  var e = !1,
    ...
    a = ["scroll", "wheel"],
    o = "undefined" != typeof WeakSet ? new WeakSet() : null;
  function c() {
    return document.querySelectorAll('video[data-autoplay="true"]');
  }
  function u(e) {
    if (!e.canPlayType) return !0;
    var t = e.currentSrc || e.src || "";
    return /\.webm(\?|$)/i.test(t)
      ? Boolean(
          e.canPlayType('video/webm; codecs="vp9"') ||
          e.canPlayType('video/webm; codecs="vp8"'),
        )
      : !(/\.mov(\?|$)/i.test(t) || /ap4h|apch|hvc1|hev1/i.test(t)) ||
          Boolean(
            e.canPlayType('video/quicktime; codecs="ap4h"') ||
            e.canPlayType('video/mp4; codecs="ap4h"') ||
            e.canPlayType('video/mp4; codecs="hvc1"') ||
            e.canPlayType('video/mp4; codecs="hev1"'),
          );
  }
  function r(e) {
    ((e.autoplay = !1),
  ...
  function d(e) {
    if (!e.offsetParent && 0 === e.getClientRects().length) return !1;
    ...
    return n.bottom > 0 && n.top < i && n.right > 0 && n.left < a;
  }
  function l(e) {
    return o ? o.has(e) : "true" === e.dataset.scrollPlayed;
  }
  function p(e) {
    (o && o.add(e), (e.dataset.scrollPlayed = "true"));
  }
  function s(e) {
    e._autoplayTimer &&
      (clearTimeout(e._autoplayTimer), (e._autoplayTimer = null));
  }
  function f(e) {
    if ((s(e), d(e) && !e.ended && e.paused && u(e))) {
      r(e);
      var t = e.play();
  ...
  function y(e) {
    if ((s(e), d(e) && !e.ended && e.paused && u(e))) {
      var t,
        ...
        i =
          ((t = e),
          !Number.isFinite((n = parseFloat(t.getAttribute("data-delay")))) ||
          n < 0
            ? 0
            : 1e3 * n);
      if (0 === i) {
      ...
      e._autoplayTimer = setTimeout(function () {
        ((e._autoplayTimer = null), d(e) && f(e));
      }, i);
    }
  }
  function v(e) {
    (s(e), e.paused || e.pause());
  }
  function h() {
...
document.addEventListener("DOMContentLoaded", () => {
  let e = document.querySelector('header[data-scroll="header"]'),
    t = document.querySelectorAll('[data-scroll]:not([data-scroll="header"])'),
    l = document.querySelector(".nav_content");
  ...
  let n = 0,
    r = () => {
      let l = e.getBoundingClientRect().bottom,
        n = !1;
      for (let r of t) {
        if ("dark" !== r.dataset.scroll) continue;
        let o = r.getBoundingClientRect();
        if (l >= o.top && l <= o.bottom) {
          n = !0;
          break;
        }
      }
      e.classList.toggle("header--dark", n);
    },
    o = () => {
      if (l && l.classList.contains("w--open")) return;
      let t = window.pageYOffset || document.documentElement.scrollTop,
        r = 5 * (0.01 * window.innerHeight),
        o = t > n;
      (t > r && o ? e.classList.add("is-hide") : e.classList.remove("is-hide"),
        (n = t <= 0 ? 0 : t));
    },
    a = () => {
      (r(), o());
...
isDesktop &&
  document.querySelectorAll(".content_composition-card").forEach((e) => {
    let t = e.querySelector(".is-compos-anim");
    if (!t) return;
    ...
    function d() {
      ((r += (i - r) * 0.12),
        (c += (o - c) * 0.12),
        (t.style.transform = `translate3d(${r - t.offsetWidth / 2}px, ${c - t.offsetHeight / 2}px, 0)`),
        (l =
          s || Math.abs(i - r) > 0.1 || Math.abs(o - c) > 0.1
    ...
    (e.addEventListener("pointerenter", p),
      ...
      e.addEventListener("pointerleave", u),
      window.addEventListener("resize", a));
  });
...
class TextAnimator {
    ...
    this.textObserver = new IntersectionObserver(
      (t) => {
        t.forEach((t) => {
          ...
          let e = t.target,
            a = this.getSettings(e);
          a && (this.playAnimation(e, a), this.textObserver.unobserve(e));
        });
      },
  ...
  getSettings(t) {
    let e = t.getAttribute("data-text");
    if ("true" === t.getAttribute("data-text-none")) return null;
    switch (e) {
      case "caption":
        return { type: "opacity", duration: 0.3 };
      case "bid-body":
        return { type: "lines", duration: 0.6, stagger: 0.08 };
      case "big-body":
        return { type: "opacity", duration: 0.6 };
      case "body":
        return { type: "opacity", duration: 0.45 };
      case "head-two":
        return {
          type: "chars",
          duration: 1.5,
      ...
      case "head-three":
        return { type: "opacity", duration: 1.25 };
      case "head-four":
        return { type: "opacity", duration: 1 };
      default:
        return null;
    }
  }
  setup(t, e) {
    if ("chars" === e.type) {
      if (e.keepWordsTogether) {
        let a = new SplitText(t, {
          type: "words,chars",
          charsClass: "char-wrap",
          wordsClass: "word-wrap",
        });
        return (
          (t.splitInstance = a),
          gsap.set(a.words, { display: "inline-block", whiteSpace: "nowrap" }),
          gsap.set(a.chars, {
            opacity: 0,
            yPercent: 20,
            willChange: "transform,opacity",
      ...
      let r = new SplitText(t, { type: "chars", charsClass: "char-wrap" });
      return (
        (t.splitInstance = r),
        gsap.set(r.chars, {
          opacity: 0,
  ...
  playAnimation(t, e) {
    let a;
    if (
      !(a = "chars" === e.type ? t.splitInstance?.chars : t) ||
      (Array.isArray(a) && !a.length)
    ) {
      console.warn("No elements to animate:", t);
      return;
    }
    gsap.to(a, {
      duration: e.duration,
      opacity: 1,
      yPercent: "chars" === e.type ? 0 : void 0,
      stagger: e.stagger || 0,
      ease: "power2.out",
      force3D: !0,
      clearProps: "willChange",
  ...
  async init() {
    ...
    document
      .querySelectorAll(
        '[data-text="caption"], [data-text="big-body"], [data-text="body"], [data-text="head-two"], [data-text="head-three"], [data-text="head-four"]',
      )
      .forEach((t) => {
        let e = this.getSettings(t);
        e && (this.setup(t, e), this.textObserver.observe(t));
      });
  }
}
window.addEventListener("load", () => {
  new TextAnimator().init();
});
...
document.addEventListener("DOMContentLoaded", () => {
  let e = document.querySelectorAll('[data-awards="scroll"]');
  if (!e.length) return;
  let t = new IntersectionObserver(
    (e, t) => {
      e.forEach((e) => {
        e.isIntersecting &&
          (e.target.classList.add("is-active"), t.unobserve(e.target));
      });
    },
...
!(function () {
  "use strict";
  var t = { duration: 1.5, stagger: 0.03 };
  function e() {
    document
      .querySelectorAll(
        '[data-text="caption"], [data-text="big-body"], [data-text="body"]',
      )
      .forEach(function (t) {
        t.setAttribute("data-text-none", "true");
      });
  }
  "loading" === document.readyState
  ...
  class a {
          ...
          t.forEach(
            function (t) {
              if (t.isIntersecting) {
                var e = t.target,
                  a = this.getSettings(e);
                a && (this.playAnimation(e, a), this.observer.unobserve(e));
              }
            }.bind(this),
          );
        }.bind(this),
    ...
    getSettings(e) {
      if ("true" === e.getAttribute("data-text-split-none")) return null;
      switch (e.getAttribute("data-text")) {
        case "caption":
          return { type: "chars", duration: t.duration, stagger: t.stagger };
        case "body":
        case "big-body":
          return { type: "words", duration: t.duration, stagger: t.stagger };
        default:
          return null;
      }
    }
    setup(t, e) {
      if ("undefined" == typeof SplitText) return null;
      if ("chars" === e.type) {
        var a = new SplitText(t, { type: "chars", charsClass: "char-wrap" });
        return (
          (t.splitInstance = a),
          gsap.set(a.chars, {
            opacity: 0,
      ...
      var n = new SplitText(t, { type: "words", wordsClass: "word-wrap" });
      return (
        (t.splitInstance = n),
        gsap.set(n.words, {
          opacity: 0,
    ...
    playAnimation(t, e) {
      var a =
        "chars" === e.type
          ? t.splitInstance && t.splitInstance.chars
          : t.splitInstance && t.splitInstance.words;
          ...
          document
            ...
            .forEach(
              function (t) {
                ...
                e && this.setup(t, e) && this.observer.observe(t);
              }.bind(this),
            ));
      }
    }
...
document.addEventListener("DOMContentLoaded", () => {
  let t = document.querySelectorAll("[data-text-counter]");
  if (!("IntersectionObserver" in window)) {
    t.forEach((t) => startCounter(t));
    return;
  }
  ...
  t.forEach((t) => {
    ((t.textContent = "0"), e.observe(t));
  });
});
function startCounter(t) {
  let e = parseFloat(t.getAttribute("data-text-counter")) || 0,
    n = performance.now();
  function r(o) {
    var a;
    let u = Math.min((o - n) / 1e3, 1),
      i = 1 - (1 - (a = u)) * (1 - a);
    ((t.textContent = Math.round(0 + (e - 0) * i)),
      u < 1 ? requestAnimationFrame(r) : (t.textContent = e));
  }
...
!(function () {
  ...
  function lockSwiper(section) {
    ...
    if (window.DataSlider && typeof window.DataSlider.lock === "function") {
      ...
      window.DataSlider &&
      typeof window.DataSlider.destroy === "function"
    ) {
  ...
  function buildIntroHeights(section) {
    ...
    if (left.length) {
      tl.fromTo(
        left,
        { height: "65svh" },
        { height: "0svh", duration: 1, ease: EASE },
        0,
      );
    }
    if (right.length) {
  ...
  function buildDesktop(section) {
    ...
    if (backsSecond.length) {
      tl.fromTo(
        backsSecond,
        { scale: 0.65 },
        { scale: 1.5, duration: 3, ease: EASE },
        0,
      );
    }
    if (backsFirst.length) {
      tl.fromTo(
        backsFirst,
        { scale: 0.65 },
        { scale: 1.25, duration: 3, ease: EASE },
        0.1,
      );
    }
    if (sliders.length) {
    ...
    if (numbers.length) {
      tl.fromTo(
        numbers,
        { opacity: 0 },
        { opacity: 1, duration: 0.001, ease: EASE },
        1,
      );
    }
    if (tools.length) {
  ...
  function buildMobile(section) {
    ...
    var tagTwo = qa(
      section,
      ".apartments_main_advantage-tag.is-relative.is-two",
    );
    var tagThree = qa(
      section,
      ".apartments_main_advantage-tag.is-relative.is-three",
    );
...
!(function () {
  ...
  function log() {
    ...
    console.log.apply(
      console,
      ["[data-slider]"].concat(Array.prototype.slice.call(arguments)),
    );
  }
  ...
  function isApartRoot(root) {
    return (
      !!(root && root.closest && root.closest(".u-section.is-apart")) ||
  ...
  function setEnabled(root, enabled) {
    ...
    var swiperEl = getSwiperEl(root);
    if (swiperEl)
      swiperEl.setAttribute("aria-disabled", enabled ? "false" : "true");
  }
  ...
  function createSwiper(root, swiperEl, opts) {
    try {
      ...
      console.warn(
        "[data-slider] Init with loop failed, retrying without loop",
        err,
      );
      opts.loop = false;
  ...
  function initSlider(root) {
    ...
    if (!qs(root, SEL.wrapper)) {
      console.warn(
        '[data-slider] [data-slider="swiper-wrapper"] not found in',
        root,
      );
      return null;
    }
    ...
    if (!slides.length) {
      console.warn(
        '[data-slider] [data-slider="swiper-slide"] not found in',
        root,
      );
      return null;
    }
    ...
    if (instance) {
      ...
      try {
        if (
          ...
          typeof instance.slideToLoop === "function"
        ) {
        ...
        function (entries) {
          entries.forEach(function (entry) {
            ...
            collectTriggers().forEach(function (trigger) {
              if (
                observeSize(trigger) === entry.target ||
  ...
  function onApartReady(event) {
    var section =
      (event && event.detail && event.detail.section) || event.target;
    if (!section) return;
    var root =
